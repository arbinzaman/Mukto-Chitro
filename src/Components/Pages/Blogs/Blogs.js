    ...
    return (
        <div className="bg-base-300 text-base-300">
            <div className="container mb-10 mt-10 max-w-4xl px-10 py-6 mx-auto rounded-lg shadow-sm bg-base-300">
                ...
                <div className="mt-3">
                    <a rel="noopener noreferrer" href="#" className="text-2xl  text-black font-bold hover:underline">Nos creasse pendere crescit angelos etc</a>
                    <p className="mt-2 text-black ">Tamquam ita veritas res equidem. Ea in ad expertus paulatim poterunt. Imo volo aspi novi tur. Ferre hic neque vulgo hae athei spero. Tantumdem naturales excaecant notaverim etc cau perfacile occurrere. Loco visa to du huic at in dixi aër.</p>
                </div>
