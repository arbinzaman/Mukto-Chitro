...
const HighLightSection = () => {
  return (
    <section>
      <div className="bg-base-300 my-20">
        <div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 dark:text-gray-900">
          <h1 className="text-5xl font-bold leading-none sm:text-6xl xl:max-w-3xl dark:text-gray-900">
            Capture Your Dream Moments With Us.{" "}
          </h1>
          <p className="mt-6 mb-8 text-lg sm:mb-12 xl:max-w-3xl dark:text-gray-900">
            Welcome to Mukto Chitro, a creative wedding photography team from
            ...
            we’ve been documenting Bangladeshi weddings for a decade & our
      ...
      <img
        src="https://weddingdiary.com.bd/wp-content/uploads/2023/05/DSC06339.jpg"
        alt=""
        className="w-3/5 mx-auto mb-12 -mt-20 rounded-lg shadow-md lg:-mt-40 dark:bg-gray-500"
      />
    </section>
  );
};
